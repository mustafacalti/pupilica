  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      const welcomeMessage: Message = {
        id: 'welcome',
        text: `Merhaba! Ben NeuroLearn AI Uzmanı. ${studentName ? `${studentName}'in gelişimi` : 'Çocuğunuzun gelişimi'} hakkında sorularınızı yanıtlamaya hazırım.\n\nSize nasıl yardımcı olabilirim?`,
        sender: 'ai',
        timestamp: new Date()
      };
