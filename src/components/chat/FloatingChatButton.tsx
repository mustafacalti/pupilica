...
export const FloatingChatButton: React.FC<FloatingChatButtonProps> = ({ studentName }) => {
  ...
  const generateAIResponse = (command: string): string => {
    switch (command) {
      case '/oyun-onerileri':
        return `${studentName ? studentName + ' için' : 'Çocuğunuz için'} önerilen oyunlar:\n\n🎯 Dikkat Sayma Oyunu - Konsantrasyon geliştirmek için\n🌈 Renk Tanıma Oyunu - Görsel algı için\n⚡ Dinamik Dikkat Oyunu - Hızlı karar verme için\n\nHangi oyunu oynamak istiyorsunuz?`;
      ...
      {isOpen && (
        <div className="fixed bottom-6 right-6 w-96 h-96 bg-white rounded-lg shadow-2xl border border-gray-200 z-50 flex flex-col">
          ...
          <div className="p-3 border-b bg-gray-50">
            <div className="text-xs text-gray-600 mb-2">Hızlı Komutlar:</div>
